...
public class AuthServiceTest extends TestCase {
    ...
    public void testGetCode() {
        AuthService service = new AuthService.Builder()
                .config("qbit1f6efee44ceb8ca2", "8f70d42a1393802aebf567be27a47879", "http://39.108.155.220:3000")
                .build();

        CodeOutput code = service.getCode("123", "http://127.0.0.1:3000");
    ...
    public void testGetAccessToken() {
        ...
        AccessTokenOutput accessToken = service.getAccessToken("983146b6575420ff87dc63a10ddd6175");
    ...
    void refreshToken() {
        AuthService service = new AuthService.Builder().config("qbit1f6efee44ceb8ca2", "8f70d42a1393802aebf567be27a47879", "http://127.0.0.1:3000").build();
        RefreshTokenOutput res = service.refreshToken("c7968e9bb72234ca6475b12da4db8c7a2b8108b2240413c24e0f35f00d32c560");
